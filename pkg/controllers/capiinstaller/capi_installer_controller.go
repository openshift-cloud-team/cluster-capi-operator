...
func (r *CapiInstallerController) extractProviderComponents(cm corev1.ConfigMap) (_ []string, err error) {
...
func configMapReader(cm corev1.ConfigMap) (io.ReadCloser, error) {
